...
#该方法导入的是libsvm格式的数据
X_train, y_train = load_svmlight_file("E:/Desktop/Image/SVMData/gender_train.txt")
X_test,y_test = load_svmlight_file("E:/Desktop/Image/SVMData/gender_predict.txt")

...
#     siftpath = 'E:/SinaSIFT'    
#     
#     userlabel = pickle.load(open(userlabelpath,"rb")).target
#     labelmat={'uid':[],'gender':[],'term':[],'influence':[],'act_level':[],'act_habit_3':[],'act_habit_2':[],'edu':[]}
#     data =[]
#     siftfiles =dataDispose.get_files('D:/siftcluster/5')
#     for file in siftfiles:
#         index  = userlabel['uid'].index(int(os.path.splitext(file)[0]))
#         labelmat['uid'].append(int(os.path.splitext(file)[0]))
#         labelmat['gender'].append(userlabel['gender'][index])
#         labelmat['edu'].append(userlabel['edu'][index])
#         labelmat['term'].append(userlabel['term'][index])
#         labelmat['influence'].append(userlabel['influence'][index])
#         labelmat['act_level'].append(userlabel['act_level'][index])
#         labelmat['act_habit_2'].append(userlabel['act_habit_2'][index])
#         labelmat['act_habit_3'].append(userlabel['act_habit_3'][index])
#         data.append(readsiftdata('D:/siftcluster/5/'+file))
#     dataset = dataPickle(data,labelmat)
#     pickle.dump(dataset, open("E:/Desktop/Image/SVMData/sina/data/sift5class_pickle.data",'wb'), True)
